...
const MEDIA_SIMPLE = `${sectionType}
...
const MEDIA_CONTAINER = `${sectionType}
[subType]:container
[mediaTypes]:["img"]
[urls]:["https://www.gstatic.com/prettyearth/assets/full/14617.jpg"]
[height]:100%
...
const MEDIA_HERO = `[sectionType]:hero
[subType]: full
[vPosition]: middle
[hPosition]: center
...
const MEDIA_SIDECAR = `${sectionType}
[subType]:sidecar
